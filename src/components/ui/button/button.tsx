...
export function Button({ variant = "delete", ...props }: ButtonProps) {
  const buttonClass = clsx(
    ...
    {
      "bg-green-100 hover:tex-green-100  text-green-700 w-full hover:bg-green-600 hover:text-zinc-50 transition-all": variant === "delete",
      "bg-green-700 flex-1 text-zinc-50": variant === "submit",
      "bg-green-700 rounded-lg text-zinc-200 w-full": variant === "secondary",
